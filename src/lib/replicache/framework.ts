...
export class Server<Mutations> {
	...
	public mutation<Name extends string, Shape extends ZodSchema, Args = z.infer<Shape>>(
		name: Name,
		shape: Shape,
...
type ExtractMutations<S extends Server<any>> = S extends Server<infer M> ? M : never
